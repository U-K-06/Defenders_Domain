...
private:
  ...
  void top_grid(int i, int GRID_SIZE, bool is_place_mode_active, int active_grid_x, int active_grid_y, TowerPositionData TowerPosition, std::vector<Enemy>& enemies, const std::vector<Bullet>& bullets, int door_x, int door_y, int color_code);
  ...
  void bottom_grid(int i, int GRID_SIZE, bool is_place_mode_active, int active_grid_x, int active_grid_y, TowerPositionData TowerPosition, std::vector<Enemy>& enemies, const std::vector<Bullet>& bullets, int door_x, int door_y, int color_code);
  void mid_grid(int i, int selection_tower, int active_tower, bool is_place_mode_active, int GRID_SIZE, int active_grid_x, int active_grid_y, int door_x, int door_y, int color_code, TowerPositionData& TowerPosition, std::vector<Enemy>& enemies);
