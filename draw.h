...
public:
  void game_name();
  void lose_game();
  void grid(int GRID_SIZE, std::string tower_names[], int active_tower, int selection_tower, int active_grid_x, int active_grid_y, bool is_place_mode_active, TowerPositionData TowerPosition, std::vector<Enemy>& enemies, int door_x, int door_y, int door_x_border, int door_y_border, int color_code, std::vector<Bullet>& bullets);
...
private:
  ...
  void top_grid(int i, int GRID_SIZE, bool is_place_mode_active, int active_grid_x, int active_grid_y, TowerPositionData TowerPosition, std::vector<Enemy>& enemies, int door_x, int door_Y, int door_x_border, int door_y_border, int color_code);
